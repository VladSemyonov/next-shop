...
export default function Category(props) {
    ...
    const promise1 = () =>{
        aaaaaaa()
            .then(() => fetch(`http://vladreact.me/server/category/${id}`, {
                method: "GET",
            }))
    ...
    async function promise2() {
        let example = {};
        let filters = await fetch(`http://vladreact.me/server/test/${id}`, {
            method: "GET",
        })
        let filters1 = await filters.json()
        let filters3 = await Object.assign(example, initObj, filters1)
        setParams(filters3)
        let result2 = await fetch(`http://vladreact.me/server/category/${id}`, {
            method: "GET",
        })
    ...
    function aaaaaaa() {
        ...
        return new Promise((resolve, reject) => {
            resolve(fetch(`http://vladreact.me/server/test/${id}`, {
                method: "GET",
            })
                .then((result) => result.json())
